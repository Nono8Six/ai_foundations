...
export declare const Constants: {
    readonly auth: {
        readonly Enums: {
            readonly aal_level: readonly ["aal1", "aal2", "aal3"];
            readonly code_challenge_method: readonly ["s256", "plain"];
            readonly factor_status: readonly ["unverified", "verified"];
            readonly factor_type: readonly ["totp", "webauthn", "phone"];
            readonly one_time_token_type: readonly ["confirmation_token", "reauthentication_token", "recovery_token", "email_change_token_new", "email_change_token_current", "phone_change_token"];
        };
    };
    readonly public: {
        readonly Enums: {
            readonly achievement_rarity: readonly ["common", "uncommon", "rare", "epic", "legendary"];
            readonly progress_status: readonly ["not_started", "in_progress", "completed"];
            readonly rgpd_request_status: readonly ["pending", "processing", "completed", "rejected"];
            readonly rgpd_request_type: readonly ["access", "deletion", "rectification"];
            readonly user_role_type: readonly ["admin", "instructor", "student"];
        };
    };
    readonly storage: {
        readonly Enums: {};
