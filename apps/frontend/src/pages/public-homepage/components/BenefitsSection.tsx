  ...
  const benefits = [
    {
      ...
      description:
        "Automatisez la saisie, la classification et l'analyse de vos documents comptables avec une précision de 95%.",
    ...
    },
    {
      ...
      description:
        "Personnalisez l'expérience client, optimisez les prix et prédisez les tendances de vente.",
    ...
    },
    {
      ...
      description:
        "Analysez les risques, détectez les fraudes et optimisez vos investissements avec l'IA.",
    ...
    },
    {
      ...
      description:
        'Prédisez les pannes, optimisez les interventions et réduisez les coûts de maintenance.',
    ...
    },
    {
      ...
      description:
        'Automatisez le recrutement, analysez les performances et optimisez la gestion des talents.',
    ...
    },
    {
      ...
      description:
        'Segmentez vos audiences, personnalisez vos campagnes et maximisez votre ROI marketing.',
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <p className='text-text-secondary mb-4 leading-relaxed'>{benefit.description}</p>
