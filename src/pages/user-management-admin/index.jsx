  ...
  const mockUsers = [
    {
      ...
      enrolledCourses: ["IA Fondamentaux", "Machine Learning", "Deep Learning", "Vision par Ordinateur"]
    },
    {
      id: 2,
      name: "Jean Martin",
    ...
    },
    {
      ...
      enrolledCourses: ["IA Fondamentaux", "Machine Learning", "Data Science", "NLP", "Computer Vision"]
    },
    {
      id: 5,
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                <Link to="/admin-dashboard" className="text-text-secondary hover:text-primary transition-colors">
                  Tableau de bord
                </Link>
                <Link to="/content-management-courses-modules-lessons" className="text-text-secondary hover:text-primary transition-colors">
                  Contenu
                </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Main Content */}
          <div className={`${showDetailsPanel ? 'lg:w-2/3' : 'w-full'} transition-all duration-300`}>
            {/* Search and Filters */}
