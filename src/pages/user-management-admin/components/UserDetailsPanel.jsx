    ...
    <div className="lg:w-1/3 bg-surface border border-border rounded-lg shadow-subtle">
      ...
      <div className="p-6 max-h-96 overflow-y-auto">
        ...
        {activeTab === 'notes' && (
          <div className="space-y-4">
            <div>
              <label className="text-sm font-medium text-text-secondary mb-2 block">Notes administratives</label>
            ...
            <div>
              <label className="text-sm font-medium text-text-secondary mb-2 block">Ajouter une note</label>
              <textarea
                rows={4}
