    ...
    <>
      ...
      `}>
        ...
        <div className="p-4 border-b border-border bg-secondary-50">
          <div className="mb-3">
            <h3 className="font-medium text-text-primary mb-1">Intelligence Artificielle pour Débutants</h3>
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-medium text-text-primary">
              {moduleStructure.reduce((total, module) => total + getCompletedCount(module.lessons), 0)} / {moduleStructure.reduce((total, module) => total + module.lessons.length, 0)}
            </span>
          </div>
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-text-secondary">
                    ...
                    <span>{getCompletedCount(module.lessons)}/{module.lessons.length} terminées</span>
                  </div>
                </div>
                <Icon 
                ...
                <div className="bg-secondary-25">
                  {module.lessons.map((lesson) => (
                    ...
                    >
                      ...
                      {/* Lesson Info */}
                      <div className="flex-1">
                        <h4 className={`font-medium mb-1 ${lesson.current ? 'text-primary' : 'text-text-primary'}`}>
                          {lesson.title}
                        </h4>
