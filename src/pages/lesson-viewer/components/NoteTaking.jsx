        ...
        <div className="p-4 border-b border-border">
          ...
          <form onSubmit={handleSubmitNote} className="space-y-3">
            <textarea
              ...
              placeholder={selectedText ? "Ajouter une note sur ce passage..." : "Écrire une nouvelle note..."}
        ...
        <div className="flex-1 overflow-auto">
          {filteredNotes.length === 0 ? (
            <div className="p-8 text-center">
              <Icon name="StickyNote" size={48} className="mx-auto text-secondary-300 mb-4" />
              <p className="text-text-secondary mb-2">
                {searchTerm ? 'Aucune note trouvée' : 'Aucune note pour le moment'}
              </p>
              <p className="text-sm text-text-secondary">
                {searchTerm ? 'Essayez un autre terme de recherche' : 'Sélectionnez du texte ou ajoutez une note personnelle'}
              </p>
            </div>
          ) : (
