          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors duration-200 ${
                formData.status === 'published' ?'bg-accent text-white hover:bg-accent-700' :'bg-warning text-white hover:bg-warning-600'
              }`}
            >
              <Icon 
                  ...
                  {formData.videoUrl ? (
                    ...
                    <div className="space-y-4">
                      <div className="aspect-video border-2 border-dashed border-secondary-300 rounded-lg flex items-center justify-center">
                        <div className="text-center">
                          <Icon name="Video" size={48} className="text-secondary-400 mx-auto mb-4" />
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className={`px-2 py-1 text-xs rounded-full ${
                    formData.status === 'published' ?'bg-accent-100 text-accent-700' :'bg-warning-100 text-warning-700'
                  }`}>
                    {formData.status === 'published' ? 'Publié' : 'Brouillon'}
                  </span>
                </div>
