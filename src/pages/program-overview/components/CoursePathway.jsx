      ...
      {orderedGroups.map((difficulty, groupIndex) => (
        <div key={difficulty} className="relative">
          ...
          <div className="flex items-center mb-8">
            <div className={`w-12 h-12 bg-gradient-to-br ${getDifficultyColor(difficulty)} rounded-full flex items-center justify-center mr-4`}>
              <Icon 
                name={difficulty === 'Débutant' ? 'Play' : difficulty === 'Intermédiaire' ? 'Zap' : 'Crown'} 
                size={24} 
                color="white" 
              />
            </div>
            <div>
              ...
              <p className="text-text-secondary">
                {groupedCourses[difficulty].length} cours disponible{groupedCourses[difficulty].length > 1 ? 's' : ''}
              </p>
            </div>
          </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-1 ml-auto">
                          ...
                          <span className="text-sm text-text-secondary">({course.enrolledStudents})</span>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      {courses.length > 0 && (
        <div className="text-center py-12 bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl">
          ...
          <p className="text-text-secondary max-w-2xl mx-auto">
            Suivez ce parcours structuré pour maîtriser l'intelligence artificielle 
            de manière progressive et efficace. Chaque cours vous prépare au suivant.
          </p>
        </div>
      )}
    </div>
