...
const AdminDashboard = () => {
  ...
  const navigationItems = [
    ...
    { name: "Gestion contenu", path: "/content-management-courses-modules-lessons", icon: "BookOpen" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-surface shadow-medium transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
      ...
      <div className="lg:pl-64">
        ...
        <main className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {quickStats.map((stat) => (
              <div key={stat.id} className="bg-surface rounded-lg p-6 shadow-subtle border border-border">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center mt-2">
                      ...
                      <span className="text-xs text-text-secondary ml-1">vs période précédente</span>
                    </div>
                  </div>
