      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Transformez votre carrière avec notre plateforme d'apprentissage IA complète. De débutant à expert, découvrez comment l'IA peut révolutionner votre productivité 
              professionnelle.
            </motion.p>
            ...
            >
              ...
              >
                <Icon name="BookOpen" size={20} className="mr-2 group-hover:scale-110 transition-transform duration-200" />
                En savoir plus
              </Link>
            </motion.div>
