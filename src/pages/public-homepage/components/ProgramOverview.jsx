...
const ProgramOverview = () => {
  const courses = [
    {
      ...
      description: "Découvrez les concepts de base de l\'intelligence artificielle et ses applications pratiques dans le monde professionnel.",
      difficulty: "Débutant",
      duration: "4 semaines",
      modules: 12,
    ...
    },
    {
      ...
      description: "Automatisez vos processus comptables avec l\'IA. Apprenez à utiliser des outils d\'automatisation pour optimiser votre productivité.",
      difficulty: "Intermédiaire",
      duration: "6 semaines",
      modules: 18,
      thumbnail: "https://images.pexels.com/photos/6863183/pexels-photo-6863183.jpeg?w=400&h=250&fit=crop",
      category: "Spécialisé",
      rating: 4.9,
      students: 1890,
    ...
    },
    {
      ...
      description: "Révolutionnez votre stratégie commerciale avec l\'IA. Personnalisation, prédiction des ventes et optimisation des prix.",
      difficulty: "Intermédiaire",
      duration: "5 semaines",
      modules: 15,
      thumbnail: "https://images.pixabay.com/photo/2020/06/25/18/25/artificial-intelligence-5339753_1280.jpg?w=400&h=250&fit=crop",
      category: "Commerce",
      rating: 4.7,
      students: 1560,
    ...
    },
    {
      ...
      description: "Maîtrisez les techniques avancées d\'apprentissage profond et développez vos propres modèles d\'IA.",
      difficulty: "Avancé",
      duration: "8 semaines",
      modules: 24,
    ...
    },
    {
      ...
      description: "Utilisez l\'IA pour l\'analyse financière, la détection de fraudes et la gestion des risques.",
      difficulty: "Intermédiaire",
      duration: "6 semaines",
      modules: 20,
      thumbnail: "https://images.pexels.com/photos/7567443/pexels-photo-7567443.jpeg?w=400&h=250&fit=crop",
      category: "Finance",
      rating: 4.8,
      students: 1230,
    ...
    },
    {
      ...
      description: "Optimisez la maintenance industrielle grâce aux algorithmes prédictifs et à l\'IoT.",
      difficulty: "Intermédiaire",
      duration: "5 semaines",
      modules: 16,
      thumbnail: "https://images.pixabay.com/photo/2018/05/08/08/44/artificial-intelligence-3382507_1280.jpg?w=400&h=250&fit=crop",
      category: "Industrie",
      rating: 4.6,
      students: 780,
  ...
  const getDifficultyColor = (difficulty) => {
    switch (difficulty) {
      case 'Débutant': return 'bg-accent-100 text-accent-700';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            Choisissez parmi nos programmes conçus pour différents secteurs professionnels 
        ...
        >
          <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-8 lg:p-12 text-white">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              Rejoignez plus de 15 000 professionnels qui ont déjà révolutionné 
              leur approche du travail grâce à l'IA
            </p>
