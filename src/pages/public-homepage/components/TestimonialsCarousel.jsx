      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            Découvrez comment nos étudiants de tous âges ont révolutionné 
            leur approche professionnelle grâce à l'IA
          </p>
        </motion.div>
                ...
                <div>
                  ...
                  <div className="bg-surface rounded-lg p-4 border border-border">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-text-secondary">Formation suivie</span>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-error-50 rounded-lg p-4 text-center border border-error-200">
                      ...
                      <p className="text-xs text-error-600">{currentTestimonial.beforeAfter.before}</p>
                    </div>
                    <div className="bg-success-50 rounded-lg p-4 text-center border border-success-200">
                      ...
                      <p className="text-xs text-success-600">{currentTestimonial.beforeAfter.after}</p>
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    <span className="inline-flex items-center px-4 py-2 bg-primary-100 text-primary-700 rounded-full text-sm font-medium">
                      ...
                      {currentTestimonial.age < 30 ? 'Jeune professionnel' : 
                       currentTestimonial.age < 50 ? 'Professionnel expérimenté': 'Senior expert'}
                    </span>
                  </div>
                </div>
              </div>
